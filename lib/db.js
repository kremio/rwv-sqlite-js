...
const getDB = ( pathToConfigFile = path.resolve(__dirname, '../config/database.json'), silent = true ) => new Promise( (success, failure) => {
  ...
  //console.log( pathToConfigFile, process.env.NODE_ENV )
  ...
  migrations.internals.argv['migrations-dir'] = path.resolve(__dirname, '../migrations')
